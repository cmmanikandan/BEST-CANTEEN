        ...
        <div className="flex items-start sm:items-center gap-3.5">
          ...
          <div>
            ...
            <h2 className="text-lg sm:text-xl font-extrabold text-[#201611] tracking-tight mt-0.5">
              {activeMealInfo?.name || 'Canteen'} Menu Live
            </h2>
            <p className="text-xs text-[#5C4E46] flex items-center gap-1.5 mt-0.5" suppressHydrationWarning>
              <Clock className="w-3.5 h-3.5 text-[#FF5722]" />
              <span>{mounted ? activeMealInfo?.statusText : 'Fresh & Hot at Counter'}</span>
            </p>
          </div>
        </div>
